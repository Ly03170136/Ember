...
const COLLISION_MATRIX = {
	...
	"enemy": {"layer": LAYER_ENEMY, "mask": LAYER_WORLD | LAYER_PLAYER | LAYER_NPC | LAYER_BUILDING | LAYER_VEHICLE},
	"npc": {"layer": LAYER_NPC, "mask": LAYER_WORLD | LAYER_PLAYER | LAYER_ENEMY | LAYER_BUILDING | LAYER_VEHICLE},
	"resource": {"layer": LAYER_RESOURCE, "mask": LAYER_WORLD | LAYER_PLAYER},
